  ...
  return (
    <div className="insights-card-6">
      <div className="group-69-6">
        <div className="x1600-i27322869202 valign-text-middle typographyheadlineh3-extrabold-30">
          {x1600I27322869202}
        </div>
        <div className="property-tax-i27322-5 valign-text-middle typography-body-smalltext-14-regular">
          {propertyTaxI27322}
        </div>
      </div>
